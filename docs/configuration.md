...
| `DEVSPACE_SHELL_PATH` | Optional explicit Bash executable path, including Git Bash installed outside standard Windows locations. Used by both `doctor` and workspace shell execution. |
